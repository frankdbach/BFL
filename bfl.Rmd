...
date: "`r Sys.Date()`"
bibliography: [BFL.bib, Mätning.bib]
bibio-style: apalike
...
# Inledning {-}
Detta dokument behandlar en pilotstudie som gjordes i ett samarbete mellan lärare i Inför huvudstudien har en pilotstudie genomförts med 23 personer, i huvudsak verksamma lärare men också några rektorer. Text om hur allt har gått till och vad som behöver göras [@concannon_college_2010].
